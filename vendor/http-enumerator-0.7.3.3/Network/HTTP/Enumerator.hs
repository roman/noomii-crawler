...
data Request m = Request
    ...
    , checkCerts :: S.ByteString -> [X509] -> IO TLS.TLSCertificateUsage -- ^ Check if the server certificate is valid. Only relevant for HTTPS.
    , host :: S.ByteString
    , port :: Int
...
defaultCheckCerts :: S.ByteString -> [X509] -> IO TLS.TLSCertificateUsage
